...
<div style="margin:32px 0 8px 0;padding:20px;border:1px solid #e7e9ee;border-radius:12px;background:#fff;box-shadow:0 3px 12px rgba(0,0,0,0.05);">
  ...
  <div style="border:1px dashed #d6d9e0;border-radius:10px;padding:14px;background:#f8fafc;color:#4b5563;line-height:1.6;">
    若需替换访问凭证，请更新 <code>token</code> 与 <code>onRefreshToken</code> 返回值后重新部署。
  </div>
