...
<!-- 智能AI助教美化区块（冷静理科风格） -->
<div style="background:#181f2a; border-radius:14px; box-shadow:0 2px 12px #e0e0e0; padding:28px 32px; margin:32px 0 36px 0; display:flex; align-items:center; gap:32px;">
  <div style="flex:1;">
    <div style="font-size:1.35em; font-weight:bold; color:#e3e8ef; margin-bottom:10px; letter-spacing:1px;">
      <span style="font-size:1.5em;">🤖</span> 智能AI助教 <span style="font-size:1.1em; color:#7da2d8;">CAT课程专属</span>
    </div>
    <div style="margin-bottom:10px;">
      <a href="https://udify.app/chat/cowvutHCzOFeVfaw" target="_blank" style="background:#232a36; color:#fff; padding:8px 18px; border-radius:6px; font-size:1.1em; text-decoration:none; font-weight:bold; box-shadow:0 2px 6px #222; transition:background 0.2s;">🌐 网页端一键进入</a>
    </div>
    <div style="font-size:1em; color:#b0b8c9;">手机端请扫码右侧二维码</div>
  </div>
...
<!-- 学期计划与资源表格区块（冷静配色+自适应宽度） -->
## 学期计划与资源

<div style="overflow-x:auto;">
<table style="min-width:900px; max-width:100%; width:100%; border-collapse:collapse; text-align:center; font-size:1em; background:#fff;">
  <tr style="background:#232a36; color:#fff;">
    <th style="border:1px solid #e0e0e0; padding:10px 16px;">课次</th>
    <th style="border:1px solid #e0e0e0; padding:10px 32px; min-width:200px;">主题与课件</th>
    <th style="border:1px solid #e0e0e0; padding:10px 24px; min-width:220px;">简介</th>
    <th style="border:1px solid #e0e0e0; padding:10px 16px;">模块</th>
  </tr>
  <tr style="background:#f6f8fa; color:#232a36;">
    <td style="border:1px solid #e0e0e0; padding:10px;">第1讲</td>
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="https://chezvivian.github.io/class/CAT_pdf/第1讲_计算机辅助翻译技术与工具概况_2025.pdf" target="_blank">计算机辅助翻译技术与工具概况</a></td>
    <td style="border:1px solid #e0e0e0; padding:10px 24px;">概述CAT的发展历程、基本原理和主要工具类型，帮助学生建立整体认知。</td>
    <td style="border:1px solid #e0e0e0; padding:10px;" rowspan="5"><b>CAT译前准备</b></td>
  </tr>
  <tr style="background:#f6f8fa; color:#232a36;">
  ...
  <tr style="background:#e9ecef; color:#232a36;">
