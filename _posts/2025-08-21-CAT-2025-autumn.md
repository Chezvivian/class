...
<table class="cat-table" style="width:100%; border-collapse:collapse; text-align:center; font-size:1em; background:#fff;">
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 40px;">计算机辅助翻译技术与工具概况</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">Word在翻译工作中的应用</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">文件格式转换</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">信息检索技术</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">语料库工具及语料库创建入门</a></td>
  ...
  <tr style="background:#f1f4f7; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">TradosStudio基本功能-安装设置和功能简介</a></td>
  ...
  <tr style="background:#f1f4f7; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">翻译术语工具应用与管理</a></td>
  ...
  <tr style="background:#f1f4f7; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">TradosStudio在翻译项目中的综合应用</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">译文质量控制技术与工具</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">机器翻译技术及应用概论</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">机器翻译的译后编辑策略方法与环境</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">影视字幕和配音翻译技术</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">作业讲评与课程总结</a></td>
