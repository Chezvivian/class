...
<table class="cat-table" style="width:100%; border-collapse:collapse; text-align:center; font-size:1em; background:#fff;">
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第4讲_信息检索技术.pdf" target="_blank">信息检索技术</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第5讲_语料库工具及语料库创建入门.pdf" target="_blank">语料库工具及语料库创建入门</a></td>
  ...
  <tr style="background:#f1f4f7; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第6讲_CAT基础_Trados基本功能.pdf" target="_blank">CAT基础：Trados基本功能</a></td>
  ...
  <tr style="background:#f1f4f7; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第7讲_CAT进阶_翻译术语工具应用与质量评估.pdf" target="_blank">CAT进阶：翻译术语工具应用与质量评估</a></td>
  ...
  <tr style="background:#f1f4f7; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第8讲_机器翻译技术及应用概论.pdf" target="_blank">机器翻译技术及应用概论</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第9讲_译后编辑策略与方法.pdf" target="_blank">译后编辑策略与方法</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第10讲_译文质量控制技术与工具.pdf" target="_blank">译文质量控制技术与工具</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;"><a href="/class/CAT_pdf/2026spring/第11讲_影视字幕和配音翻译技术.pdf" target="_blank">影视字幕和配音翻译技术</a></td>
  ...
  <tr style="background:#f9fafb; color:#2d3a4a;">
    ...
    <td style="border:1px solid #e0e0e0; padding:10px 32px;">小组汇报</td>
    <td style="border:1px solid #e0e0e0; padding:10px 12px; font-size:0.8em;">学生小组成果汇报展示。</td>
  </tr>
</table>
